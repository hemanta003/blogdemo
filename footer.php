...
<footer class="bg-dark text-white pt-5 pb-4">
    <div class="footerbox text-center text-md-left">
      <div class="row text-center text-md-left">
        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
          <h5 class="text-uppercase mb-4 font-weight-bold text-warning">Company Name</h5>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi iure quia dolor dolorem unde nemo?</p>
        </div>
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
          ...
          <p><a href="#" class="text-white" style="text-decoration: none;">Sourcefile</a></p>
          <p><a href="#" class="text-white" style="text-decoration: none;">Bootstrap5 link</a></p>
        </div>
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
          ...
          <p><a href="#" class="text-white" style="text-decoration: none;">Email</a></p>
        </div>
        <div class="col-md-4 col-lg-2 col-xl-2 mx-auto mt-3">
          <h5 class="text-uppercase mb-4 font-weight-bold text-warning">Contact Us</h5>
          <p>
            <i class="fas fa-home mr-3"></i>Gtcsys,b205,CorporateRoad, profitaire A,Ahmedabad
          </p>
          <p>
            <i class="fas fa-envelope mr-3"></i>gtcsys_help@gmail.com
          </p>
          <p>
            <i class="fas fa-phone mr-3"></i>+91 9876543423
          </p>
          <p>
            <i class="fas fa-print mr-3"></i>+91 654352829
          </p>
        </div>
        <hr class="mb-4">
        <div class="row align-items-center">
          <div class="col-md-7 col-lg-8">
            <p>Copyright @2022 All Rights Reserved By: <a href="#" style="text-decoration: none;"> <strong
                  class="text-warning">The Providers</strong></a></p>
          </div>
